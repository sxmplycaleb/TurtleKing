...
const Map<String, List<String>> _requiredConcepts = {
  ...
  'yamada': ['strategic surrender', 'smallest hand'],
  'holdOut': ['hold out', 'reveal'],
  'reveal': ['takes shots', 'extra shot', 'smallest'],
  'cupSizes': ['round 1', 'round 2', 'escalate'],
  'drinkingCounts': ['shot', 'six'],
